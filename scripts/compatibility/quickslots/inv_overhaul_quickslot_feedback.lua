maintask InvOverhaulQuickslotFeedback do
  ...
  function PublishRemovalHint(ordinal: int, oldCount: int) -> void
    ...
    native.SetVariable("inv_overhaul_inventory_removed_ordinal_old_count", oldCount)
    native.SetVariable("inv_overhaul_inventory_removed_ordinal_valid", 1)
    native.Trace("inv_overhaul_quickslot UI removal hint ordinal=" + ordinal +
      " old=" + oldCount)
  end
  ...
  function UseConsumable(slot: int, category: int, index: int, candidateItemID: int) -> void
    ...
    native.Trace("inv_overhaul_quickslot UI UseItem result=" + used +
    ...
    MarkInventoryChanged()
    ShowFeedback(candidateItemID)
    native.Trace("inv_overhaul_quickslot UI consumed item=" + candidateItemID +
      " remaining=" + remaining)
  end
  ...
  function init() -> void
    ...
    native.Trace("INV_OVERHAUL_QUICKSLOT_FEEDBACK_VERSION 2026.07.30-ui-runtime-1")
