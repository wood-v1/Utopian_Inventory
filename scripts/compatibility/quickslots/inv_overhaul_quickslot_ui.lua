maintask InvOverhaulQuickslotUIRuntime do
  ...
  function UseConsumable(slot: int, category: int, index: int, itemID: int) -> void
    ...
    native.Trace("inv_overhaul_quickslot window UseItem result=" + used +
  ...
  function ActivateQuickslot(slot: int) -> void
    ...
    native.Trace("inv_overhaul_quickslot window activate slot=" + slot +
  ...
  function init() -> void
    ...
    local request: int = 0
    native.GetVariable("inv_overhaul_quickslot_action_request", request)
    native.SetVariable("inv_overhaul_quickslot_action_request", 0)
