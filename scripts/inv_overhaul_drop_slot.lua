maintask InvOverhaulDropSlot do
  ...
  function OnMouseEnter() -> void
    ...
    native.SetVariable("inv_overhaul_inventory_tooltip_text_id", c_iDropTooltipTextID)
    native.SetVariable("inv_overhaul_inventory_tooltip_type", c_iTooltipMapObject)
    native.SetTooltip(c_iTooltipMapObject, tooltip)
  ...
  function OnMouseLeave() -> void
    native.SetVariable("inv_overhaul_inventory_tooltip_item", -1)
    native.SetVariable("inv_overhaul_inventory_tooltip_type", -1)
  end
